...
In figure \ref{fig:istep} we have the histograms of the test statistic after the ?th step of training, we can observe the difference to the end result. \todo{fig:istep}
